            ...
            <div class="float-right">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="#">Surat Pengantar Mata Kuliah</a>
                    </li>
                    <li class="breadcrumb-item active">Index</li>
                </ol>
            </div>
            <h4 class="page-title">Surat Pengantar Mata Kuliah</h4>
        </div>
    </div>
</div>
                ...
                <table id="datatable" class="table table-striped table-bordered table-hover nowrap" style="width:100%">
                    ...
                    <?php foreach($data as $key => $dt) { ?>
                        <tr>
                            ...
                            <td><?= $dt['Status'] ?></td>
                            <td>
                                <a href="?p=surat_spmk&form=view&id=<?= $dt['id'] ?>" class="btn btn-info" title="View">
