        ...
        <div class="card">
            <div class="card-body">
                <div class="mt-0 header-title mb-4">
                    <a class="btn btn-primary waves-effect waves-light" href="?p=surat_berkelakuan_baik&form"><i
                            class="fas fa-plus"></i>
                            <?= lang ('Ajukan Surat') ?>
                    </a>
                </div>
                ...
                <table id="datatable" class="table table-striped table-bordered table-hover nowrap" style="width:100%">
                    ...
                    <?php foreach($data as $key => $dt) { ?>
                        <tr>
                            ...
                            <td><?= $dt['status'] ?></td>
                            <td>
                                <a href="?p=surat_berkelakuan_baik&form=view&id=<?= $dt['id'] ?>" class="btn btn-info" title="<?= lang('Lihat Data') ?>">
                                    <i class="fa fa-eye"></i>
                                </a>
